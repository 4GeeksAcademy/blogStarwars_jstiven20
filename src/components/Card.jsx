      ...
      <div className="card-body">
        ...
        {details && (
          <ul className="list-unstyled">
            {details.gender && <li><strong>Gender:</strong> {details.gender}</li>}
            {details.hair_color && <li><strong>Hair Color:</strong> {details.hair_color}</li>}
            {details.eye_color && <li><strong>Eye Color:</strong> {details.eye_color}</li>}
          </ul>
        )}
